...
| No root text guide to the site. | Added build-generated `/llms.txt` linking the business, booking, all four services, pricing, and all 20 guides. Linked it from page metadata; the text menu is discoverable through this file and the sitemap, with no technical menu link in the customer-facing homepage. |
