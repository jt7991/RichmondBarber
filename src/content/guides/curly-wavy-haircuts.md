...
related:
  ...
  - summer-hair-richmond
sources:
  - title: "American Academy of Dermatology: Curly hair care"
...
| --- | --- |
| Fringe | Above the eyebrows, off the forehead, or long enough to move aside |
| Sides | Close around the ears, softly tapered, or visibly curly |
| Top | Compact shape, movement, or retained length |
| Neck | Clean perimeter or a longer natural outline |
...
Show a photo if available, explain where the dry length ended up, and point to your preferred endpoint. Ask to preserve extra length initially so you can assess the shape before taking more off.
